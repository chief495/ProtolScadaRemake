...
namespace ProtolScadaRemake
{
    public class TElementLt
    {
        ...
        public TVariableTag LowLevelVariable; // Нижняя граница измеряемой температуры датчика
        public TVariableTag HiLevelVariable; // Верхняя граница измеряемой температуры датчика
        ...
        public TCommandTag LowLevelCommand; // Нижняя граница измеряемой температуры датчика
        public TCommandTag HiLevelCommand; // Верхняя граница измеряемой температуры датчика
        ...
        public TElementLt(TGlobal G, string N, ushort AddressIn, ushort AddressOut, int VarGroup, ushort CommAddr) // Конструктор
        {
            Global = G;
            Name = N;
