namespace ProtolScadaRemake
{
    public class TElementPt
    {
        ...
        public TElementPt(TGlobal G, string N, ushort AddressIn, ushort AddressOut, int VarGroup, ushort CommAddr) // Конструктор
        {
            ...
            LowPressVariable = Global.Variables.Add(Name + "_LowPress", Group, (ushort)(InputAddress + 0x03), 1, "Float_32", "", "##0.#", "", "Нижняя граница измеряемого давления датчика " + Name);
            HiPressVariable = Global.Variables.Add(Name + "_HiPress", Group, (ushort)(InputAddress + 0x05), 1, "Float_32", "", "##0.#", "", "Верхняя граница измеряемого давления датчика " + Name);
            ...
            LowPressCommand = Global.Commands.Add(Name + "_LowPress", Global.Plc_IpAddress, Global.Plc_PortNum, Global.Plc_DeviceAddress, "Holding Registers", (ushort)(CommandAddress + 0x03), "Float_32", "##0.##", "Нижняя граница измеряемого давления датчика " + Name);
            HiPressCommand = Global.Commands.Add(Name + "_HiPress", Global.Plc_IpAddress, Global.Plc_PortNum, Global.Plc_DeviceAddress, "Holding Registers", (ushort)(CommandAddress + 0x05), "Float_32", "##0.##", "Верхняя граница измеряемого давления датчика " + Name);
